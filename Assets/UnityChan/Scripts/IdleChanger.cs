...
// Require these components when using this script
	...
	public class IdleChanger : MonoBehaviour
	{
		...
		{
			int height = 235;
			GUI.Box (new Rect (Screen.width - 110, 10, 100, 40 + height + 10 + height), "Change Motion");
			if (GUI.Button (new Rect (Screen.width - 100, 40, 80, height), "Next"))
				anim.SetBool ("Next", true);
			if (GUI.Button (new Rect (Screen.width - 100, 40 + height + 10, 80, height), "Back"))
				anim.SetBool ("Back", true);
		}
